<?php require_once RUTA_APP . '/views/inc/header.php'; ?>
            <div class="view view-cascade gradient-card-header red accent-4 narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                <div></div>
                <a href="#" class="white-text mx-3">DOCTORES</a>
                <div></div>
            </div>
            <div class="container-fluid">
                ...
                <?php require_once RUTA_APP . '/views/modals/modalInsert.php'; ?>
                    <form class="text-center p-5" id="InsertDoctor" method="POST">
                        <p class="h4 mb-4">NUEVO DOCTOR</p>
                        ...
                        <div class="md-form form-sm">
                            ...
                            <label for="form8" class="active">Especialidad:</label>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="dtBasicExample" class="table table-striped table-bordered dt-responsive nowrap" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="th-sm">ESPECIALIDAD</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td>
                                    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                        <div class="btn-group mr-2 white-text" role="group" aria-label="First group">
                                            <a id="UpdateDoctorModal" data-toggle="modal" onclick="UpdateDoctor(<?php echo $doctor->id_doctor; ?>)" data-target="#UpdateModal" class="btn-sm amber darken-1"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                            <a id="DeleteDoctorModal" onclick="DeleteDoctor(<?php echo $doctor->id_doctor; ?>)" class="btn-sm red darken-1" data-toggle="modal" data-target="#modalConfirmDelete"><i class="fas fa-trash" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                </td>
                                <td id="nombre<?php echo $doctor->id_doctor; ?>"><?php echo strtoupper($doctor->nombre_doctor); ?></td>
                                <td id="app<?php echo $doctor->id_doctor; ?>"><?php echo strtoupper($doctor->app_doctor); ?></td>
                                <td id="apm<?php echo $doctor->id_doctor; ?>"><?php echo strtoupper($doctor->apm_doctor); ?></td>
                                <td id="especialidad<?php echo $doctor->id_doctor; ?>"><?php echo strtoupper($doctor->especialidad_doctor); ?></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
                    <?php require_once RUTA_APP . '/views/modals/modalUpdate.php'; ?>
                        <form id="UpdateDoctor" class="text-center p-5" method="POST">
                            ...
                            <div class="md-form form-sm">
                                <input type="text" name="especialidad" id="formEspecialidad" class="form-control">
                                <label for="form8" class="active">Especialidad:</label>
                            </div>
                    ...
                    <!-- Funciones Scripts-->
                    <script language="JavaScript" type="text/javascript" src="<?php echo RUTA_URL ?>/js/pages/doctor.js"></script>
                </div>  
